...
// â”€â”€â”€ NCCLEnvVarViz â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
          ...
          return (
            <div key={v.name} className="rounded-xl overflow-hidden"
              ...
              >
                ...
                <span className="text-slate-600 text-xs ml-2">{isOpen ? "â–²" : "â–¼"}</span>
              </button>
                ...
                <div className="px-4 pb-4 space-y-3 text-xs border-t border-white/8 pt-3">
                  ...
                  <div className="grid gap-2 sm:grid-cols-2">
                    <div className="rounded-lg bg-green-900/20 border border-green-500/20 p-3">
                      <div className="text-[10px] text-green-400 mb-1">âœ“ Correct</div>
                    ...
                    <div className="rounded-lg bg-red-900/20 border border-red-500/20 p-3">
                      <div className="text-[10px] text-red-400 mb-1">âœ— Wrong (common mistake)</div>
