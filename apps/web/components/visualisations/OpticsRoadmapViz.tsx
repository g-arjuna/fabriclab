...
const generations: {
  ...
  },
  {
    ...
    modulation: "PAM-4",
    fec: true,
    keyFact: "Every DGX H100 NIC port and every SN5600 switch port runs at 400G. Supply stable, costs falling.",
    color: "#14532d",
    border: "#22c55e",
  },
  {
    id: "800G",
    speed: "800G",
    label: "B200 / H200 era — ramping now",
    status: "ramping",
    statusLabel: "⚡ Fastest-growing segment (Dell'Oro 2026)",
    dgx: "DGX H200 / DGX B200",
