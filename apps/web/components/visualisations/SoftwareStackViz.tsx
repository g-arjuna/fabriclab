...
const devices: Device[] = [
  ...
  },
  {
    ...
    color: "#4c1d95",
    border: "#a78bfa",
    description: "Each BlueField-3 DPU runs its own Ubuntu instance on embedded Arm CPUs — completely independent of the DGX host OS. It has its own management IP, its own file system, and can be rebooted without touching the host. You reach it via SSH or via the rshim PCIe console interface from the host.",
    ...
    notes: "The DPU has two separate OS contexts: Arm-side (what you SSH into) and host-side (what the DGX OS sees). They communicate via rshim.",
  },
  {
    id: "ufm",
    name: "UFM Server",
