...
const anatomyComponents = [
  ...
  { label: "BlueField-3 DPU × 2", role: "Storage + security", detail: "2 BlueField-3 DPUs for storage fabric (NVMe-oF) and out-of-band management. Completely separate from the compute NICs. GPUDirect Storage path.", color: "#6d28d9" },
