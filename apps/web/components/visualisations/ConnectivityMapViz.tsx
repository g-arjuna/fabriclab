...
const networks: Record<Network, NetworkDetail> = {
  oob: {
    ...
    color: "#1e293b",
    border: "#64748b",
    path: "Management workstation → 1GbE switch → iDRAC port (DGX) / MGMT port (ONYX switch) / management ports on supporting appliances",
    software: "iDRAC web GUI, IPMI, SSH to ONYX management interface",
  ...
  storage: {
    ...
    color: "#065f46",
    border: "#4ade80",
    path: "DGX Slot1/Slot2 dual-port ConnectX-7 ports → Spectrum SN5600 switch → NVMe-oF storage arrays (WEKA, Lustre, NetApp)",
    software: "NVMe-oF protocol, GPUDirect Storage (GDS), host NVMe-oF initiator over the storage ConnectX-7 ports",
