...
<Image
  src="/images/ch4-infiniband-operations/onyx-console-access.svg"
  alt="Illustration comparing QM9700 front-panel micro-USB console access with Q3400 RJ45 serial console access."
  width={1200}
  height={700}
...
<Image
  src="/images/ch4-infiniband-operations/nvidia-ufm-network-map.png"
  alt="Official NVIDIA UFM network map screenshot showing a selected switch and its nearby fabric links."
  width={1207}
  height={817}
/>
