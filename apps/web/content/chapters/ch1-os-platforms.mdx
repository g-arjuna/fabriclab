...
<Image
  src="/images/ch1-os-platforms/nvidia-base-command-manager-overview.png"
...
*Figure: Official NVIDIA Base Command Manager interface screenshot. This is the kind of cluster-level view the chapter is referring to when it says Day 0 work is often orchestrated through BCM rather than performed node by node.*
