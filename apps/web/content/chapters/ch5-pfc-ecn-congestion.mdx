...
<Image
  src="/images/ch5-pfc-ecn-congestion/pause-propagation-deadlock-map.svg"
  alt="Animated technical diagram showing a PFC pause frame propagating hop by hop through a leaf-spine-leaf path and then turning into a circular deadlock dependency."
  width={1600}
  height={900}
...
<Image
  src="/images/ch5-pfc-ecn-congestion/ecn-pfc-threshold-ladder.svg"
  alt="Illustration of a switch egress queue showing ECN minimum threshold, ECN maximum threshold, PFC headroom threshold, and buffer maximum in the correct operational order."
  width={1600}
  height={1100}
  style={{ objectFit: "contain" }}
/>
...
<Image
  src="/images/ch5-pfc-ecn-congestion/rate-control-vs-pause-thrash.svg"
  alt="Comparison diagram showing the same burst handled in two ways: ECN plus DCQCN bends sender rate before the queue lives in the PFC zone, while missing ECN produces stop-start pause thrash."
  width={1600}
  height={1100}
  style={{ objectFit: "contain" }}
/>
*Figure: The same burst can feel almost invisible when ECN shapes senders early, or painfully jagged when PAUSE becomes the primary control loop.*
...
<Image
  src="/images/ch5-pfc-ecn-congestion/silent-congestion-diagnostic-triad.svg"
  alt="Operations illustration showing the three-part silent congestion fingerprint: high switch buffer utilisation, modest but growing PFC pause counters, and zero ECN marks on the host NIC."
  width={1600}
  height={1100}
  style={{ objectFit: "contain" }}
/>
...
<Image
  src="/images/ch5-pfc-ecn-congestion/cross-layer-congestion-signatures.svg"
  alt="Comparison matrix showing how healthy bursts, silent congestion, and capacity failure look across application behavior, switch counters, NIC counters, and operator interpretation."
  width={1600}
  height={1200}
  style={{ objectFit: "contain" }}
/>
*Figure: This is the cross-check that keeps you from chasing the wrong fix. Similar slowdowns mean different things depending on whether ECN marks are present on the NIC and whether drops appear on the switch.*
